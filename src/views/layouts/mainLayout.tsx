        ...
        <footer className='md:px-12 mb-[120px] flex flex-row justify-center w-full'>
          <div className='max-w-[1090px] '>
            <div className='container-dark text-xs  overflow-x-hidden md:overflow-x-visible'>
              <p className='px-12 py-4'>The site uses cookies to log the amount of traffic, however because of the technical limitations of GitHub Pages, I am limited to using things like Google Analytics to get this type of statistics. Even with all types of options turned off, some data will be collected if you accepted the cookies. If you choose to change your choice, please click here: <button className='hover:drop-shadow-md underline'
                onClick={() => resetCookieConsent()}
              >Reset cookies</button>. Please note this refreshes the page. Ensure you have saved any build you are working on.</p>
            </div>
          </div>
        </footer>
      </div>
