...
export const CompanionIcon = ({ companion, label = true, level = 1, border = true, stars = true, mp = true }: { companion: Game.Companion | undefined, label?: boolean, level?: number, border?: boolean, stars?: boolean, mp?: boolean }) => {
